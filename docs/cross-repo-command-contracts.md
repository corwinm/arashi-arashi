...
The authoritative workflow runs on meta-repository changes and manual dispatch. Child repositories do **not** dispatch it yet: cross-repository authentication, coordinated PR refs, and status reporting should be designed together in a follow-up. Child-local freshness/consistency gates remain independently useful in the meantime.
