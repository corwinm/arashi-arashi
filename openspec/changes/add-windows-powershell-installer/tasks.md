...
- [x] 1.6 Run an installed wrapper `--version` smoke test and print direct GitHub Releases fallback guidance for download, checksum, PATH, and smoke-test failures.
