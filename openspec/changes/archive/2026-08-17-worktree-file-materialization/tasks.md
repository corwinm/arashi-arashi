...
- [ ] 11.4 Commit and push archive output in a focused follow-up meta PR with the sole `Closes #273` linkage; list archive paths, validation, the merged child PRs, and the already-merged proposal/meta PR #296
