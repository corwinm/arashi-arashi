...
- [ ] 4.5 Strictly validate the active OpenSpec change before archive; only after default-branch proof, archive it, strictly validate all resulting canonical specs, commit the meta repository at the exact merged child head, open the meta PR, and merge it after exact-head checks pass
