...
- [ ] 3.2 Implement workspace-scoped setting persistence: `ConfigurationTarget.Workspace` for single-folder workspaces and `ConfigurationTarget.WorkspaceFolder` for affected multi-root folders, followed by effective-value verification.
