# verified-release-commits Specification

## Purpose
Define how Arashi's semantic-release workflow creates GitHub-verified, GPG-signed metadata commits while preserving the existing release topology and isolating signing secrets.
