...
## Purpose
Define the user-facing command execution contract for running arbitrary child commands across selected Arashi-managed repositories, including repository selection, grouped output, bounded parallelism, fail-fast behavior, documentation, and agent guidance.
## Requirements
