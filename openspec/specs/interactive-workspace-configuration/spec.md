# interactive-workspace-configuration Specification

## Purpose
Define the supported `aw configure` inspection and interactive-editing workflow, including product-owned scope, effective-state projection, safe inline-hook handling, exact confirmation, and transactional persistence.
