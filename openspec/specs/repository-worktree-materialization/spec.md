# repository-worktree-materialization Specification

## Purpose

Define how configured coordinated repository worktrees safely copy or symlink same-relative-path content from canonical primary checkouts during create, and how planning, rollback, output, and diagnostics expose that behavior.
