# vscode-configured-repository-discovery Specification

## Purpose

Define how the VS Code extension derives and recommends the minimum `git.repositoryScanMaxDepth` needed to surface configured Arashi child repositories while preserving editor scope, explicit consent, retry safety, and workspace lifecycle behavior.
