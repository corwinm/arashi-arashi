# node-test-execution Specification

## Purpose
Define Node-based test execution across Arashi repositories while preserving behavioral coverage, platform support, and explicit boundaries for the remaining Bun compiler usage.
