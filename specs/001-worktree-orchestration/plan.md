...
**Branch**: `001-worktree-orchestration` | **Date**: 2026-02-04 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/001-worktree-orchestration/spec.md`
...
```text
specs/001-worktree-orchestration/
