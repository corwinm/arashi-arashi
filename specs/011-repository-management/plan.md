...
**Branch**: `011-repository-management` | **Date**: 2026-02-04 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/011-repository-management/spec.md`
...
```text
specs/011-repository-management/
