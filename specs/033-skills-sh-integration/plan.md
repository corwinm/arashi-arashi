...
**Storage**: File system (skill metadata and documentation)  
...
**Scale/Scope**: One skill package, one canonical skill definition, >=3 documented workflows, one quickstart, one troubleshooting path, and one cross-link section in main Arashi docs
...
- **IV. User-Centric Interface**: PASS - Requires quickstart, workflow guidance, and troubleshooting clarity.
