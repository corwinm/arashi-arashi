...
**Branch**: `016-nested-worktree-paths` | **Date**: 2026-02-05 | **Spec**: [spec.md](spec.md)
**Input**: Feature specification from `/specs/016-nested-worktree-paths/spec.md`
...
```text
specs/016-nested-worktree-paths/
