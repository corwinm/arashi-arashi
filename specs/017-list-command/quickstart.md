...
Create `repos/arashi/src/types/list.ts` with types from `/specs/017-list-command/contracts/list-api.ts`.
...
4. Create a pull request with reference to spec: `specs/017-list-command/spec.md`
